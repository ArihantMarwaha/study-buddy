...
struct FormattingToolbar_Previews: PreviewProvider {
    ...
    @State static var textColor: Color = .primary
    @State static var backgroundColor: Color = .yellow.opacity(0.8)
    @State static var borderColor: Color = .yellow
    @State static var isBold: Bool = false
    @State static var isItalic: Bool = false
    @State static var isUnderlined: Bool = false
    @State static var isStrikethrough: Bool = false
    @State static var cornerRadius: CGFloat = 8
    @State static var borderWidth: CGFloat = 1
    @State static var opacity: Double = 1.0
    @State static var fontFamily: String = "System"
    @State static var showCustomizationPanel: Bool = true
    ...
    static var previews: some View {
        ...
        .frame(maxWidth: 500)
        .previewDisplayName("FormattingToolbar Preview")
    }
}

struct CustomizationPanel_Previews: PreviewProvider {
    @State static var backgroundColor: Color = .yellow.opacity(0.8)
    @State static var borderColor: Color = .yellow
    @State static var cornerRadius: CGFloat = 8
    @State static var borderWidth: CGFloat = 1
    @State static var opacity: Double = 1.0
    @State static var fontFamily: String = "System"
    static let fontFamilies = ["System", "Helvetica", "Times", "Courier", "Georgia", "Verdana"]
    ...
    static var previews: some View {
        ...
        .previewDisplayName("CustomizationPanel Preview")
    }
}
...
struct FormatButton_Previews: PreviewProvider {
    static var previews: some View {
        HStack(spacing: 12) {
            FormatButton(icon: "bold", isActive: true, action: {})
            FormatButton(icon: "italic", isActive: false, action: {})
            FormatButton(icon: "underline", isActive: true, action: {})
            FormatButton(icon: "strikethrough", isActive: false, action: {})
        }
        .padding()
        .previewLayout(.sizeThatFits)
        .glassEffect()
        .previewDisplayName("FormatButton Preview")
    }
}
